...
// CMD_TFItem.cs - Automatic processing of commands.
...
{
	public interface IMI_TFItem_ClassInterface
	{
		...
		TFI_Tipo Tipo { get; set; }
		TFI_XCant XCant { get; set; }
		byte[] GetCommand();
	}

    [ClassInterface(ClassInterfaceType.None)]
	public class MI_TFItem 
		: MInput
		, IMI_TFItem_ClassInterface
	{
		...
		public TFI_Tipo Tipo { get; set; }
		public TFI_XCant XCant { get; set; }
		public override byte[] GetCommand()
		{
			...
			try
			{
				...
				SetOpcode(0x0B02, extension, list);
	...
	public interface IMO_TFItem_ClassInterface
	{
    ...
    [ClassInterface(ClassInterfaceType.None)]
	public class MO_TFItem  
		: MOutput
		, IMO_TFItem_ClassInterface
	{
	...
	public interface ICMD_TFItem_ClassInterface
	{
		...
		IMI_TFItem_ClassInterface Input { get; }
		IMO_TFItem_ClassInterface Output { get; }
	}

    [ClassInterface(ClassInterfaceType.None)]
	public class CMD_TFItem 
	    : CMD_Generic
		, ICMD_TFItem_ClassInterface
	{
		public override CmdStatus Status {  get { return CmdStatus.EnCurso; }}
		public override string Nombre { get { return "TFItem"; }}
		public override int Opcode { get { return 0x0B02; }}
		...
		public IMI_TFItem_ClassInterface Input { get; protected set; }
		public IMO_TFItem_ClassInterface Output { get; protected set; }

		public void SetDefaults()
		{
			Input = new MI_TFItem();
			Output = new MO_TFItem();
		}
