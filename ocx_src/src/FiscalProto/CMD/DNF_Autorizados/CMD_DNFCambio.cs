...
// CMD_DNFCambio.cs - Automatic processing of commands.
...
{
	public interface IMI_DNFCambio_ClassInterface
	{
	...
	public class MI_DNFCambio 
		: MInput
		, IMI_DNFCambio_ClassInterface
	{
		...
		public override byte[] GetCommand()
		{
			...
			try
			{
				...
				SetOpcode(0x0F07, extension, list);
	...
	public interface IMO_DNFCambio_ClassInterface
	{
		int Numero { get; set; }
    ...
    [ClassInterface(ClassInterfaceType.None)]
	public class MO_DNFCambio  
		: MOutput
		, IMO_DNFCambio_ClassInterface
	{
	...
	public interface ICMD_DNFCambio_ClassInterface
	{
		...
		IMI_DNFCambio_ClassInterface Input { get; }
		IMO_DNFCambio_ClassInterface Output { get; }
	}

    [ClassInterface(ClassInterfaceType.None)]
	public class CMD_DNFCambio 
	    : CMD_Generic
		, ICMD_DNFCambio_ClassInterface
	{
		public override CmdStatus Status {  get { return CmdStatus.Listo; }}
		public override string Nombre { get { return "DNFCambio"; }}
		public override int Opcode { get { return 0x0F07; }}
		public override string Description { get { return "Realiza la impresión de un talón de cambio."; }}

		public IMI_DNFCambio_ClassInterface Input { get; protected set; }
		public IMO_DNFCambio_ClassInterface Output { get; protected set; }

		public void SetDefaults()
		{
			Input = new MI_DNFCambio();
			Output = new MO_DNFCambio();
		}

		// Ctor
		public CMD_DNFCambio()
		{
			SetDefaults();
		}
	}
