...
{
	public class MI_DFNHCerrar : MInput
	{
		...
		[Description("Numero de lineas en blanco para la firma (0-3)."), Category("Datos")]
	...
	public class MO_DFNHCerrar  : MOutput
	{
	...
	public class CMD_DFNHCerrar 
	    : CMD_CommandBase<MI_DFNHCerrar, MO_DFNHCerrar>
	{
