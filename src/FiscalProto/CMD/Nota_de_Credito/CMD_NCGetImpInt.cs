...
// CMD_NCGetImpInt.cs - Automatic processing of commands.
...
{
	public class MI_NCGetImpInt : MInput
	{
		...
		public override byte[] GetCommand()
		{
			...
			try
			{
				...
				SetOpcode(0x0D0E, extension, list);
			}
	...
	public class MO_NCGetImpInt  : MOutput
	{
		...
		[Description("Monto de impuestos internos (fijos y porcentuales) facturado por la tasa de iva indicada antes (1/7)."), Category("Datos"), ReadOnly(true)]
		...
		[Description("Monto de impuestos internos (fijos y porcentuales) facturado por la tasa de iva indicada antes (2/7)."), Category("Datos"), ReadOnly(true)]
		...
		[Description("Monto de impuestos internos (fijos y porcentuales) facturado por la tasa de iva indicada antes (3/7)."), Category("Datos"), ReadOnly(true)]
		...
		[Description("Monto de impuestos internos (fijos y porcentuales) facturado por la tasa de iva indicada antes (4/7)."), Category("Datos"), ReadOnly(true)]
		...
		[Description("Monto de impuestos internos (fijos y porcentuales) facturado por la tasa de iva indicada antes (5/7)."), Category("Datos"), ReadOnly(true)]
		...
		[Description("Monto de impuestos internos (fijos y porcentuales) facturado por la tasa de iva indicada antes (6/7)."), Category("Datos"), ReadOnly(true)]
		...
		[Description("Monto de impuestos internos (fijos y porcentuales) facturado por la tasa de iva indicada antes (7/7)."), Category("Datos"), ReadOnly(true)]
	...
	public class CMD_NCGetImpInt 
	    : CMD_CommandBase<MI_NCGetImpInt, MO_NCGetImpInt>
	{
		public override CmdStatus Status {  get { return CmdStatus.EnCurso; }}
		public override string Nombre { get { return "NCGetImpInt"; }}
		public override int Opcode { get { return 0x0D0E; }}
		...
		// Ctor
		public CMD_NCGetImpInt()
		{
			Input = new MI_NCGetImpInt();
			Output = new MO_NCGetImpInt();
		}
	}
}
