...
{
	public class MI_TFGetOtrosTrib : MInput
	{

		[Description("Indice (comenzando en 1) del tributo para el cuál se requiere información."), Category("Datos")]
	...
	public class MO_TFGetOtrosTrib  : MOutput
	{
	...
	public class CMD_TFGetOtrosTrib 
	    : CMD_CommandBase<MI_TFGetOtrosTrib, MO_TFGetOtrosTrib>
	{
