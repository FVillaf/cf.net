...
{
	public interface IMI_NCGetVentas_ClassInterface
	{
	...
	public class MI_NCGetVentas 
		: MInput
		, IMI_NCGetVentas_ClassInterface
	{
	...
	public interface IMO_NCGetVentas_ClassInterface
	{
    ...
    [ClassInterface(ClassInterfaceType.None)]
	public class MO_NCGetVentas  
		: MOutput
		, IMO_NCGetVentas_ClassInterface
	{
	...
	public interface ICMD_NCGetVentas_ClassInterface
	{
		...
		IMI_NCGetVentas_ClassInterface Input { get; }
		IMO_NCGetVentas_ClassInterface Output { get; }
	}

    [ClassInterface(ClassInterfaceType.None)]
	public class CMD_NCGetVentas 
	    : CMD_Generic
		, ICMD_NCGetVentas_ClassInterface
	{
		...
		public IMI_NCGetVentas_ClassInterface Input { get; protected set; }
		public IMO_NCGetVentas_ClassInterface Output { get; protected set; }
