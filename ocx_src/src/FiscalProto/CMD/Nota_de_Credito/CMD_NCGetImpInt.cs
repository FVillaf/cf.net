...
{
	public interface IMI_NCGetImpInt_ClassInterface
	{
	...
	public class MI_NCGetImpInt 
		: MInput
		, IMI_NCGetImpInt_ClassInterface
	{
	...
	public interface IMO_NCGetImpInt_ClassInterface
	{
    ...
    [ClassInterface(ClassInterfaceType.None)]
	public class MO_NCGetImpInt  
		: MOutput
		, IMO_NCGetImpInt_ClassInterface
	{
	...
	public interface ICMD_NCGetImpInt_ClassInterface
	{
		...
		IMI_NCGetImpInt_ClassInterface Input { get; }
		IMO_NCGetImpInt_ClassInterface Output { get; }
	}

    [ClassInterface(ClassInterfaceType.None)]
	public class CMD_NCGetImpInt 
	    : CMD_Generic
		, ICMD_NCGetImpInt_ClassInterface
	{
		...
		public IMI_NCGetImpInt_ClassInterface Input { get; protected set; }
		public IMO_NCGetImpInt_ClassInterface Output { get; protected set; }
