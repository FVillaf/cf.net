...
// CMD_NCGetConfig.cs - Automatic processing of commands.
...
{
	public interface IMI_NCGetConfig_ClassInterface
	{
		byte[] GetCommand();
	}

    [ClassInterface(ClassInterfaceType.None)]
	public class MI_NCGetConfig 
		: MInput
		, IMI_NCGetConfig_ClassInterface
	{
		public override byte[] GetCommand()
		{
			...
			{
				int extension = 0;
				SetOpcode(0x0D09, extension, list);
			}
	...
	public interface IMO_NCGetConfig_ClassInterface
	{
    ...
    [ClassInterface(ClassInterfaceType.None)]
	public class MO_NCGetConfig  
		: MOutput
		, IMO_NCGetConfig_ClassInterface
	{
	...
	public interface ICMD_NCGetConfig_ClassInterface
	{
		...
		IMI_NCGetConfig_ClassInterface Input { get; }
		IMO_NCGetConfig_ClassInterface Output { get; }
	}

    [ClassInterface(ClassInterfaceType.None)]
	public class CMD_NCGetConfig 
	    : CMD_Generic
		, ICMD_NCGetConfig_ClassInterface
	{
		public override CmdStatus Status {  get { return CmdStatus.EnCurso; }}
		public override string Nombre { get { return "NCGetConfig"; }}
		public override int Opcode { get { return 0x0D09; }}
		public override string Description { get { return "Obtiene la configuracion por default para todas las notas de crédito que se emitan."; }}

		public IMI_NCGetConfig_ClassInterface Input { get; protected set; }
		public IMO_NCGetConfig_ClassInterface Output { get; protected set; }

		public void SetDefaults()
		{
			Input = new MI_NCGetConfig();
			Output = new MO_NCGetConfig();
		}

		// Ctor
		public CMD_NCGetConfig()
		{
			SetDefaults();
		}
	}
