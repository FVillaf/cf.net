...
{
	public interface IMI_TFCerrar_ClassInterface
	{
	...
	public class MI_TFCerrar 
		: MInput
		, IMI_TFCerrar_ClassInterface
	{
	...
	public interface IMO_TFCerrar_ClassInterface
	{
    ...
    [ClassInterface(ClassInterfaceType.None)]
	public class MO_TFCerrar  
		: MOutput
		, IMO_TFCerrar_ClassInterface
	{
	...
	public interface ICMD_TFCerrar_ClassInterface
	{
		...
		IMI_TFCerrar_ClassInterface Input { get; }
		IMO_TFCerrar_ClassInterface Output { get; }
	}

    [ClassInterface(ClassInterfaceType.None)]
	public class CMD_TFCerrar 
	    : CMD_Generic
		, ICMD_TFCerrar_ClassInterface
	{
		...
		public IMI_TFCerrar_ClassInterface Input { get; protected set; }
		public IMO_TFCerrar_ClassInterface Output { get; protected set; }
