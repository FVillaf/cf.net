...
// CMD_DNFHItem.cs - Automatic processing of commands.
...
{
	public interface IMI_DNFHItem_ClassInterface
	{
		...
		string Palabras { get; set; }
		bool SendSubtot { get; set; }
		bool Leyenda { get; set; }
		bool PosiLeyenda { get; set; }
		bool ImportesBrutos { get; set; }
		DNFHI_Tipo Tipo { get; set; }
		DNFHI_XCant XCant { get; set; }
		byte[] GetCommand();
	}

    [ClassInterface(ClassInterfaceType.None)]
	public class MI_DNFHItem 
		: MInput
		, IMI_DNFHItem_ClassInterface
	{
		...
		public DNFHI_Tipo Tipo { get; set; }
		public DNFHI_XCant XCant { get; set; }
		public override byte[] GetCommand()
		{
			...
			try
			{
				...
				SetOpcode(0x1002, extension, list);
				...
				Append_RT(list, Palabras, -1, 0, true);
			}
	...
	public interface IMO_DNFHItem_ClassInterface
	{
    ...
    [ClassInterface(ClassInterfaceType.None)]
	public class MO_DNFHItem  
		: MOutput
		, IMO_DNFHItem_ClassInterface
	{
	...
	public interface ICMD_DNFHItem_ClassInterface
	{
		...
		IMI_DNFHItem_ClassInterface Input { get; }
		IMO_DNFHItem_ClassInterface Output { get; }
	}

    [ClassInterface(ClassInterfaceType.None)]
	public class CMD_DNFHItem 
	    : CMD_Generic
		, ICMD_DNFHItem_ClassInterface
	{
		public override CmdStatus Status {  get { return CmdStatus.EnCurso; }}
		public override string Nombre { get { return "DNFHItem"; }}
		public override int Opcode { get { return 0x1002; }}
		public override string Description { get { return "Registra un ítem al DNFH en curso."; }}

		public IMI_DNFHItem_ClassInterface Input { get; protected set; }
		public IMO_DNFHItem_ClassInterface Output { get; protected set; }

		public void SetDefaults()
		{
			Input = new MI_DNFHItem();
			Output = new MO_DNFHItem();
		}
	...
	public enum DNFHI_Tipo 
	{
		...
		Anticipo = 8,	// 1000
		AjuAnticipo = 9,	// 1001
		DescAnticipo = 10,	// 1010
		AjuDescAnticipo = 11,	// 1011
	};

	public enum DNFHI_XCant 
	{
		PorQ = 0,	// 00
		Por1 = 1,	// 01
		Por0 = 2,	// 10
