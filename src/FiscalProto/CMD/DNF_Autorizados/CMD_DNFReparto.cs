...
{
	public class MI_DNFReparto : MInput
	{

		[Description("Primera linea de 'Domicilio'."), Category("Datos")]
		public string LDomicilio1 { get; set; }

		[Description("Segunda linea de 'Domicilio'."), Category("Datos")]
		public string LDomicilio2 { get; set; }

		[Description("Tercera linea de 'Domicilio'."), Category("Datos")]
	...
	public class MO_DNFReparto  : MOutput
	{
	...
	public class CMD_DNFReparto 
	    : CMD_CommandBase<MI_DNFReparto, MO_DNFReparto>
	{
