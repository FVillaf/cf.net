...
{
	public interface IMI_TFGetUltimoCierre_ClassInterface
	{
		byte[] GetCommand();
	}

    [ClassInterface(ClassInterfaceType.None)]
	public class MI_TFGetUltimoCierre 
		: MInput
		, IMI_TFGetUltimoCierre_ClassInterface
	{
	...
	public interface IMO_TFGetUltimoCierre_ClassInterface
	{
    ...
    [ClassInterface(ClassInterfaceType.None)]
	public class MO_TFGetUltimoCierre  
		: MOutput
		, IMO_TFGetUltimoCierre_ClassInterface
	{
	...
	public interface ICMD_TFGetUltimoCierre_ClassInterface
	{
		...
		IMI_TFGetUltimoCierre_ClassInterface Input { get; }
		IMO_TFGetUltimoCierre_ClassInterface Output { get; }
	}

    [ClassInterface(ClassInterfaceType.None)]
	public class CMD_TFGetUltimoCierre 
	    : CMD_Generic
		, ICMD_TFGetUltimoCierre_ClassInterface
	{
		...
		public IMI_TFGetUltimoCierre_ClassInterface Input { get; protected set; }
		public IMO_TFGetUltimoCierre_ClassInterface Output { get; protected set; }
