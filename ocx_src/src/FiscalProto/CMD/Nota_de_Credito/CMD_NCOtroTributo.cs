...
{
	public interface IMI_NCOtroTributo_ClassInterface
	{
		...
		NCOT_Tipo Tipo { get; set; }
		byte[] GetCommand();
	}

    [ClassInterface(ClassInterfaceType.None)]
	public class MI_NCOtroTributo 
		: MInput
		, IMI_NCOtroTributo_ClassInterface
	{
	...
	public interface IMO_NCOtroTributo_ClassInterface
	{
    ...
    [ClassInterface(ClassInterfaceType.None)]
	public class MO_NCOtroTributo  
		: MOutput
		, IMO_NCOtroTributo_ClassInterface
	{
	...
	public interface ICMD_NCOtroTributo_ClassInterface
	{
		...
		IMI_NCOtroTributo_ClassInterface Input { get; }
		IMO_NCOtroTributo_ClassInterface Output { get; }
	}

    [ClassInterface(ClassInterfaceType.None)]
	public class CMD_NCOtroTributo 
	    : CMD_Generic
		, ICMD_NCOtroTributo_ClassInterface
	{
		...
		public IMI_NCOtroTributo_ClassInterface Input { get; protected set; }
		public IMO_NCOtroTributo_ClassInterface Output { get; protected set; }
