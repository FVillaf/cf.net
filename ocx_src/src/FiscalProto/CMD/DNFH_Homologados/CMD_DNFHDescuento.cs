...
{
	public interface IMI_DNFHDescuento_ClassInterface
	{
		...
		DNFHD_Tipo Tipo { get; set; }
		byte[] GetCommand();
	}

    [ClassInterface(ClassInterfaceType.None)]
	public class MI_DNFHDescuento 
		: MInput
		, IMI_DNFHDescuento_ClassInterface
	{
	...
	public interface IMO_DNFHDescuento_ClassInterface
	{
		decimal Monto { get; set; }
    ...
    [ClassInterface(ClassInterfaceType.None)]
	public class MO_DNFHDescuento  
		: MOutput
		, IMO_DNFHDescuento_ClassInterface
	{
		public decimal Monto { get; set; }
	...
	public interface ICMD_DNFHDescuento_ClassInterface
	{
		...
		IMI_DNFHDescuento_ClassInterface Input { get; }
		IMO_DNFHDescuento_ClassInterface Output { get; }
	}

    [ClassInterface(ClassInterfaceType.None)]
	public class CMD_DNFHDescuento 
	    : CMD_Generic
		, ICMD_DNFHDescuento_ClassInterface
	{
		...
		public IMI_DNFHDescuento_ClassInterface Input { get; protected set; }
		public IMO_DNFHDescuento_ClassInterface Output { get; protected set; }
