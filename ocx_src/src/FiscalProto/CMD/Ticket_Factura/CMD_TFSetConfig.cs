...
{
	public interface IMI_TFSetConfig_ClassInterface
	{
	...
	public class MI_TFSetConfig 
		: MInput
		, IMI_TFSetConfig_ClassInterface
	{
	...
	public interface IMO_TFSetConfig_ClassInterface
	{
    ...
    [ClassInterface(ClassInterfaceType.None)]
	public class MO_TFSetConfig  
		: MOutput
		, IMO_TFSetConfig_ClassInterface
	{
	...
	public interface ICMD_TFSetConfig_ClassInterface
	{
		...
		IMI_TFSetConfig_ClassInterface Input { get; }
		IMO_TFSetConfig_ClassInterface Output { get; }
	}

    [ClassInterface(ClassInterfaceType.None)]
	public class CMD_TFSetConfig 
	    : CMD_Generic
		, ICMD_TFSetConfig_ClassInterface
	{
		...
		public IMI_TFSetConfig_ClassInterface Input { get; protected set; }
		public IMO_TFSetConfig_ClassInterface Output { get; protected set; }
