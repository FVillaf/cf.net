...
// CMD_NCSubtotal2.cs - Automatic processing of commands.
...
{
	public interface IMI_NCSubtotal2_ClassInterface
	{
		bool Print { get; set; }
		byte[] GetCommand();
	}
	...
	public class MI_NCSubtotal2 
		: MInput
		, IMI_NCSubtotal2_ClassInterface
	{
		...
		public override byte[] GetCommand()
		{
			...
			try
			{
				...
				SetOpcode(0x0D23, extension, list);
			}
	...
	public interface IMO_NCSubtotal2_ClassInterface
	{
    ...
    [ClassInterface(ClassInterfaceType.None)]
	public class MO_NCSubtotal2  
		: MOutput
		, IMO_NCSubtotal2_ClassInterface
	{
	...
	public interface ICMD_NCSubtotal2_ClassInterface
	{
		...
		IMI_NCSubtotal2_ClassInterface Input { get; }
		IMO_NCSubtotal2_ClassInterface Output { get; }
	}

    [ClassInterface(ClassInterfaceType.None)]
	public class CMD_NCSubtotal2 
	    : CMD_Generic
		, ICMD_NCSubtotal2_ClassInterface
	{
		public override CmdStatus Status {  get { return CmdStatus.EnCurso; }}
		public override string Nombre { get { return "NCSubtotal2"; }}
		public override int Opcode { get { return 0x0D23; }}
		...
		public IMI_NCSubtotal2_ClassInterface Input { get; protected set; }
		public IMO_NCSubtotal2_ClassInterface Output { get; protected set; }

		public void SetDefaults()
		{
			Input = new MI_NCSubtotal2();
			Output = new MO_NCSubtotal2();
		}

		// Ctor
		public CMD_NCSubtotal2()
		{
			SetDefaults();
		}
	}
