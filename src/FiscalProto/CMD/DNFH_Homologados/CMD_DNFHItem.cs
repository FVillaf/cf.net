...
{
	public class MI_DNFHItem : MInput
	{
		...
		[Description("Monto del ítem, en palabras."), Category("Datos")]
		...
		[Category("Extension")]
		[Description(
			"Indica si debe o no usar la 'Leyenda Larga' al imprimir el item.\n" +
			"false: Corta, true: Larga")]
		public bool Leyenda { get; set; }

		[Category("Extension")]
		[Description(
			"Indica donde imprimir la 'Leyenda'. \n" +
			"false: EnLinea, true: Arriba")]
		public bool PosiLeyenda { get; set; }

		[Category("Extension")]
		[Description(
			"Indica si todos los montos deben considerarse netos de IVA, o montos brutos\n" +
			"false: Netos, true: Brutos")]
	...
	public class MO_DNFHItem  : MOutput
	{
	...
	public class CMD_DNFHItem 
	    : CMD_CommandBase<MI_DNFHItem, MO_DNFHItem>
	{
