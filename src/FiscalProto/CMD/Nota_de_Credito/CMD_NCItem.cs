...
namespace FiscalProto.Nota_de_Credito
{
	public class MI_NCItem : MInput
	{
		...
		[Category("Extension")]
		[Description(
			"Cuando la cantidad es el valor 1, use este bit para elegir si imprimir o no la linea de cantidad\n" +
			"false: No, true: Si")]
	...
	public class MO_NCItem  : MOutput
	{
	...
	public class CMD_NCItem 
	    : CMD_CommandBase<MI_NCItem, MO_NCItem>
	{
